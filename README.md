...
## ⚙️ Local Installation (Dev Setup)



Follow these steps to run ValiDoc locally on your machine:
...
git clone https://github.com/Devsarthak279/ValiDoc.git
...
6. Opne new terminal and navigate to ValiDoc:
